...
bios:
  ...
  art: >
    Miriam is an author, performer, and ceramic artist --
    the author of _Riding SideSaddle*_
    (SpringGun Press, 2015),
    and won the True West Award
    for co-authoring the adaptation
    _10 Myths on the Proper Application of Beauty Products_
    (Buntport Theater, 2016).
    Recent theater productions include
    _Jane/Eyre_ (Grapefruit Lab & Teacup Gorilla, 2025);
    _Whiskey From Strangers_ (GL & TG, 2024);
    _Strange Bird, Queer Bird_ (GL & TG, 2023);
    and _Letters of Suresh_ (Curious Theater, 2023).
    Several of those have also become soundtrack albums
    by Teacup Gorilla.
  life: >
    Miriam likes exploring strange rabbit holes,
    or pouring _attention_ into a craft
    with other people.
photos:
