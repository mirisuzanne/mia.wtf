...
<figure>
  <hwb-color-table
    data-format="hwb"
    role="img"
    aria-label="gradient black through cyan to white on the x axis, gray to cyan on the y axis, only the edges are gray"
  ></hwb-color-table>
  <figcaption>
    An HWB table of colors using <code>180deg hue</code>,
    incrementing <code>whiteness</code> and <code>blackness</code>
...
<figure>
  <show-gradient
    style="--stops: hsl(0deg 100% 0%), hsl(45deg 100% 12.5%), hsl(90deg 100% 25%), hsl(135deg 100% 37.5%), hsl(180deg 100% 50%);"
    aria-label="A gradient from black to cyan, passing through several other hues on the way."
  ></show-gradient>
</figure>
...
<figure>
  <show-gradient
    style="--stops: hsl(0deg 100% 0%), hsl(180deg 100% 50%);"
    aria-label="A smooth gradient from black to cyan."
  ></show-gradient>
</figure>
...
<figure>
  <show-gradient
    style="--stops: hwb(0deg 80% 20%), hwb(0deg 100% 25%), hwb(0deg 2530% 25%);"
    aria-label="A gradient that is actually just the same gray all the way along."
  ></show-gradient>
</figure>
